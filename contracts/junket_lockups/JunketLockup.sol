...
contract JunketLockup {
  ...
  uint256 public year = 2 minutes; // equivalent to one year

  function JunketLockup(address _token, address _beneficiary)public {
  ...
  function release() public {
    ...
    if (diff > year){
        ...
        releaseTime = now.add(year.sub(diff));
    }
